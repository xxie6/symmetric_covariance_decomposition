...
This is a scatter plot of $\hat{L}_{gb-more-binary}$, the estimate from symEBcovMF:
```{r}
...
This is a scatter plot of $\hat{L}_{gb-more-binary-backfit}$, the estimate from symEBcovMF with backfit:
```{r}
