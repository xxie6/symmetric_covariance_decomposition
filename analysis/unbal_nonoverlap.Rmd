...
## Observations
symEBcovMF does a relatively good job at recovering the four population effects. Interestingly, while factor 3 primarily recovers the third group effect, it has a small (but still notable) loading on the first group effect. I explore this more in another analysis.
